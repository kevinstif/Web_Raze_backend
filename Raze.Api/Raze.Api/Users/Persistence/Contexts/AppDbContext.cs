    ...
    public class AppDbContext :DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<User>().HasData(
                ...
                new UserAdvisor{Id = 3,FirstName = "Drake",LastName = "Bell",UserName = "Drell",Password = "hamburgesa",Age = 23,Premium =false,TypeUser =EUserType.Advisor,YearsExperience = 13,Rank = 273,Profession = "Teacher"}, new UserAdvised{Id = 4,FirstName = "Loriam",LastName = "KARL",UserName = "kARLO",Password = "dracula25",Age = 22,Premium =false,TypeUser =EUserType.Advised,Mood = 2},
