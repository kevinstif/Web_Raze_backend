...
@post-adding
	Scenario: Add Post
		When A Post Request is Sent
		  ...
		  | Best summer outfit | image 1 | Use a striped t-shirt this summer | 1      | 3          | 2     |
		Then A Response with status 200 is received
		And A Post Resource is included in Response Body
		  | id | title              | image   | description                       | rate | numberOfRates | userId | interestId | tagId |
		  | 2  | Best summer outfit | image 1 | Use a striped t-shirt this summer | 0    | 0             | 1      | 3          | 2     |
      
	Scenario: Add Post with Invalid Tag
		When A Post Request is Sent
		  | Title              | Image   | Description                       | UserId | InterestId | TagId |
		  | Best autumn outfit | image 1 | Use a striped t-shirt this autumn | 1      | 3          | -20    |
		Then A Response with status 400 is received 
		And A Message of "Tag not found." is included in Response 
	...
	Scenario: Add Post with Invalid Interest
		...
		Then A Response with status 400 is received 
		And A Message of "Interest not found." is included in Response 
		
	Scenario: Add Post with Invalid User
		When A Post Request is Sent
		  | Title              | Image   | Description                       | UserId | InterestId | TagId |
		  | Best autumn outfit | image 1 | Use a striped t-shirt this autumn | -1      | 3          | 2    |
		Then A Response with status 400 is received 
		And A Message of "User not found." is included in Response 
